...
class NoDealsOutOfRange extends Component {
    ...
    render() {
        ...
        const formNotSubmittedMessage = `Our service is not currently available in your area. Please${isMobile ? ' change your zip code or' : ''} provide your email so that we can notify you when we arrive. We apologize for the inconvenience.`;
        ...
        return (
            <div className="deals__no-matches">
                ...
                {isMobile ? (
                    <button className="deals__button deals__button--pink deals__button--zip" onClick={this.props.toggleSmallFiltersShown}>
                        Change Zip
                    </button>
                ) : (
                    null
...
export default connect(mapStateToProps, Actions)(NoDealsOutOfRange);
